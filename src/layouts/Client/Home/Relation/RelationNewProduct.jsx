...
export default function RelationNewProduct() {
    return (
        <div className="col-md-4 col-12">
            ...
            <div className="relation__list">
                <div className="relation__item">
                    <figure>
                        <a href=""><img src="./assets/img/relation/04.jpg" alt="*" /></a>
                    </figure>
                ...
                <div className="relation__item">
                    <figure>
                        <a href=""><img src="./assets/img/relation/05.jpg" alt="*" /></a>
                    </figure>
                    <div className="relation__text">
                        <h3><a href="#">GoPro Hero4 Silver</a></h3>
                        <div className="relation__price"><span>$287.99</span></div>
                ...
                <div className="relation__item">
                    <figure>
                        <a href=""><img src="./assets/img/relation/06.jpg" alt="*" /></a>
                    </figure>
                    <div className="relation__text">
                        <h3><a href="#">GoPro Hero4 Silver</a></h3>
                        <div className="relation__price"><span>$287.99</span></div>
